  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#020617] dark:bg-gradient-to-br dark:from-[#020617] dark:via-[#0f172a] dark:to-[#1e293b]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[70%] right-[30%] h-10 w-10 border-2 border-white/10 rotate-12 animate-float" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up group perspective-1000">
        <Card className="bg-slate-900/40 backdrop-blur-xl border-border/40 shadow-2xl animate-glow-pulse transition-all duration-700 group-hover:[transform:rotateX(6deg)_rotateY(10deg)] transform-gpu">
          <CardHeader className="text-center pb-2 space-y-3">
            ...
            <div>
              <CardTitle className="text-3xl font-black text-white tracking-tighter uppercase">Smart Timetable</CardTitle>
              <p className="text-xs text-primary/70 mt-2 font-black uppercase tracking-[0.25em]">GMR Institute of Technology</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="h-12 bg-slate-950/50 border-white/10 text-white placeholder:text-white/20 focus:border-primary focus:ring-primary/20 transition-all rounded-xl text-base font-bold"
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="••••••••"
                    required
                    className="h-12 bg-slate-950/50 border-white/10 text-white placeholder:text-white/20 focus:border-primary focus:ring-primary/20 transition-all pr-12 rounded-xl text-base font-bold"
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-gradient-to-r from-primary to-accent hover:opacity-90 text-white font-black uppercase tracking-widest shadow-xl shadow-primary/20 transition-all hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98] rounded-xl border-0"
                disabled={loading}
              >
                {loading ? 'Authenticating...' : 'Sign In Now'}
              </Button>
            </form>
            <p className="text-xs text-center text-white/40 mt-8 font-bold uppercase tracking-widest">
              Don't have an account?{' '}
              <Link to="/signup" className="text-primary hover:text-accent underline underline-offset-4 transition-colors">
                Initialize Access
              </Link>
            </p>
            <p className="text-[10px] text-center text-white/20 mt-4 font-black uppercase tracking-[0.2em]">
              GMRIT CSE DEPARTMENT © 2026
            </p>
          </CardContent>
        </Card>
      </div>
